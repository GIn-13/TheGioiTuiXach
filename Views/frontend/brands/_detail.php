...
<?php $brandName= $brand[0]['name'];$allCategory=0;$brandId =$_GET['id'] ?? null;?>
...
<div id="show-product">
		<div id="category-link">
			<p>Trang chủ / <?php echo $brandName;?></p>
		</div>
		<div id="div-show">
			<div id="div-brand">
				<h3>THƯƠNG HIỆU</h3>
				...
				<div id="product-show-bottom">
					<ul>
						<?php 
							...
							?>
							<a style="width: 50px;"  class="page-item" href="?controller=brand&action=show&id=<?php print $brandId;?>&page=<?=$prev_page?>">Trước</a>
						<?php }  ?>
						...
						<?php for ($num=1;$num<=$totalPages;$num++) {?>
							<?php if($num != $current_page) { ?>
								<?php if($num >$current_page-2 && $num <$current_page +2) { ?>
									<a class="page-item" href="?controller=brand&action=show&id=<?php print $brandId;?>&page=<?=$num?>"><?=$num?></a>
								<?php } ?>
							<?php  } else { ?>
						...
						<?php 
							...
							?>
							<a style="width: 50px;"  class="page-item" href="?controller=brand&action=show&id=<?php print $brandId;?>&page=<?=$next_page?>">Sau</a>
						<?php }  ?>
